import { MeshBasicMaterial, Mesh, PlaneGeometry, TextureLoader } from "three";
...
export default class Particle {
  ...
  gatherParticles(particle) {
    ...
    particle.position.x =
      (minDistance + Math.random() * (maxDistance - minDistance)) * x;
    particle.position.y =
      minDistance + Math.random() * (maxDistance - minDistance);
    particle.position.z =
      (minDistance + Math.random() * (maxDistance - minDistance)) * z;
